...
public class testLesson {
	...
	public static void main(String[] args) {
		...
		Lesson oop = new Lesson("OOP", Days.TUE, new Time(14,30), new Time(1, 30), Format.OFFLINE);
		Lesson algo = new Lesson("ADS", Days.WED, new Time(13,30), new Time(1, 0), Format.ONLINE);
		Lesson db = new Lesson("DB", Days.TUE, new Time(14,30), new Time(15, 30), Format.OFFLINE);
		Lesson math = new Lesson("MATH", Days.TUE, new Time(19,30), new Time(20, 50), Format.ONLINE); //Format will be null
